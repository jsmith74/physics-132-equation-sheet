...
\begin{document}
	\begin{multicols*}{5}
		...
		\subsection*{Capacitance of Parallel Plates}
		...
		$$ a \sin \theta_p = p \lambda \quad p=1,2,3\dots$$ 
		...
		\subsection*{Reflection}
						$$ \theta_r = \theta_i \quad \mbox{(reflection)}$$
						$$ \theta_c = \sin^{-1}(\frac{n_2}{n_1}) \quad  \mbox{(TIR)}$$
		...
		$$ \mbox{If } a(t) = a \quad \mbox{(constant in time),} $$
		$$ v = v_0 + a t $$
