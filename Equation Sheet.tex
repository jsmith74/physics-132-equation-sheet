...
\begin{document}
	\begin{multicols*}{5}
		...
		$$ h = 6.63 \times 10^{-34} Js = 4.14 \times 10^{-15} eVs$$
		\subsection*{Bohr radius}
		$$ a_B = 5.29 \times 10^{-11} m$$
		...
		$$ \small E_z = \frac{\eta}{2 \epsilon_0} (1-\frac{z}{\sqrt{z^2+R^2}}) \quad \mbox{(disc of charge)}$$
		...
		$$ \sum_{\mbox{n in loop}} (\Delta V_n) = 0$$
		\subsection*{$\Delta V$ Across Components: }
		...
		$$ \small u_B = \frac{1}{2 \mu_0} B^2 \quad \mbox{(inductor energy density)}$$
		...
		$$\vec{B} = \frac{\mu_0}{4 \pi} \frac{I \Delta \vec{s} \times \hat{r}}{r^2} \quad \mbox{(segment of current)}$$
		...
		$$ \small  \Phi_m = \vec{B} \cdot \vec{A} = |\vec{B}||\vec{A}|\cos\theta \quad \mbox{(uniform B)} $$
